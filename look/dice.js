...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-73855435');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-73855435');}
...
var brandEl=document.querySelector('.rl-brand-73855435');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
